...
//        String password = XxlConfClient.get("default.jdbc.password",null);
        ...
        String url = "jdbc:mysql://106.14.115.221:3306/peseer_online?Unicode=true&characterEncoding=UTF-8&remarks=true&useInformationSchema=true";
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.peseer.ops.model.online.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/peseer/ops/model/online/base";

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.peseer.ops.model.online";
