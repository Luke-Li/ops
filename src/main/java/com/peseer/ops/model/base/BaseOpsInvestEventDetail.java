...
public abstract class BaseOpsInvestEventDetail<M extends BaseOpsInvestEventDetail<M>> extends Model<M> implements IBean {

	/**
	 * 表名
	 */
	public static final String TableName = "ops_invest_event_detail";
