...
import com.peseer.ops.model._BaseModelGenerator;
import com.peseer.ops.model._MetaBuilder;
import com.peseer.ops.model._ModelGenerator;

/**
 * 在数据库表有任何变动时，运行一下 main 方法，极速响应变化进行代码重构
 */
public class _JFinalPeseerGenerator {
...
//        String password = XxlConfClient.get("default.jdbc.password",null);
        ...
        String url = "jdbc:mysql://10.47.113.150:3306/peseer_login?Unicode=true&characterEncoding=UTF-8&remarks=true&useInformationSchema=true";

        DruidPlugin c3p0Plugin = new  DruidPlugin(url,"root","password");
        c3p0Plugin.start();
        return c3p0Plugin.getDataSource();
	}
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.peseer.ops.model.account.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/peseer/ops/model/account/base";

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.peseer.ops.model.account";
